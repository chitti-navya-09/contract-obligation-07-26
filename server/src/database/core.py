...
mock_db = {
    ...
    "users": [
        { "id": "USR-101", "name": "Admin User", "email": "admin@company.com", "role": "Admin", "status": "Active", "lastLogin": "2026-07-20" },
        { "id": "USR-102", "name": "Jane Doe", "email": "jane.doe@company.com", "role": "Manager", "status": "Active", "lastLogin": "2026-07-19" },
        { "id": "USR-103", "name": "John Smith", "email": "john.smith@company.com", "role": "User", "status": "Inactive", "lastLogin": "2026-06-15" },
        { "id": "USR-104", "name": "Alice Wong", "email": "alice.wong@company.com", "role": "User", "status": "Active", "lastLogin": "2026-07-18" },
        { "id": "USR-105", "name": "Bob Davis", "email": "bob.davis@company.com", "role": "Auditor", "status": "Pending", "lastLogin": "Never" }
    ],
    "obligations": [

...
//   {
//     id: "CTR-2024-009",
//     title: "Supply Agreement — GlobalTech",
...
//       <div className="expiring-contracts-list">
...
//               </div>
//               <div>
//                 <p className="contract-item__title">{contract.title}</p>
//                 <p className="contract-item__subtitle">
//                   {contract.company} · Expires {contract.expires}
//                 </p>
//               </div>
//             </div>

//             <div className="contract-item__status">
//               <div>
//                 <p className="contract-item__days">{contract.daysLeft} days</p>
//                 <p className="contract-item__value">{contract.value}</p>
//               </div>
